...
:root {
  ...
  ### Fonts
 /* Font family */
  --font-christmas: "Great Vibes", cursive;
...
## Testing
 - https://github.com/ogc1231/festive-quiz-game/blob/main/TESTING.md

## User Stories
- Settings Create page - As a user I can view the quiz settings page, so that I can adjust the settings to suit my needs.
- Homepage Create - As a user I can view a homepage, so that I can learn about the purpose of the website.
- Settings Create settings form - As a user I can adjust the quiz game settings, so that I can experience different question difficulties and types.
- Navbar - As a user I can navigate around the pages with the navbar.
- Quizpage - As a user I can start the game on the quiz game site.
- Leaderboard - As a user I can view my score and compare to other players. 
